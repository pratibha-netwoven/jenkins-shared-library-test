...
class MsTeamsHelper {    
    ...
    * }
    */
    def teamsSend(String teamsWebhookUrl, String type, String teamsTeamName, String teamsChannelName, String threadId, String replyId, String status, String msgTitle, String msgBody, Closure httpRequestClosure) 
    {   
